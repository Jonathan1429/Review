...
class TestSetPintarLetraUseCase {
    ...
    fun se_aplica_color_al_ultimo_caracter(){
        ...
        // No hay una igualación porque se aplica en el mismo editable
        setPintarLetraUseCase(editable, cursorPosition, color)

        val spans = editable.getSpans(cursorPosition - 1, cursorPosition, ForegroundColorSpan::class.java)
