...
public class Fragment_DialogColores_popup extends DialogFragment {
    private FragmentColoresBinding binding;
    private int colorActual = 0;

    public Fragment_DialogColores_popup() {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.colorPickerView.setColorListener(new ColorListener() {
            ...
            public void onColorSelected(int color, boolean fromUser) {
                ...
                Activity_Cuestionario actividCuestionario = (Activity_Cuestionario) getActivity();
