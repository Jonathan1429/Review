package com.jonathanev.review.data.datastore.preferences
        ...
        produceMigrations = { context ->
            listOf(
                SharedPreferencesMigration(
                    context = context,
                    // "Este archivo ya no es usado aunque se encuentre en el dispositivo
                    sharedPreferencesName = "CONTADOR_IMAGENES"
                )
            )
        }
    )*/
