...
import com.example.repasar.Activities.Activity_RepasarGuia;
import com.example.repasar.Clases.Guias;
import com.example.repasar.Fragments.Adaptadores.AdaptadorPersonalizadoListarGuias;
import com.example.repasar.R;
import com.example.repasar.databinding.FragmentListarGuiasBinding;
...
public class Fragment_DialogListarGuias_popup extends DialogFragment {
                ...
                new AlertDialog.Builder(getActivity())
                        ...
                        .setNegativeButton("Eliminar Guia", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int i) {
                                ...
                                if (file.exists()){
                                    new File(file, guias.getNombreGuia()).delete();
    ...
    private void cargarListaGuiasEstudio(ArrayList<String> item) {
        ...
        for (int i = 0; i < item.size(); i++) {
            guias = new Guias();
            guias.setImgGuia(R.drawable.cerebro);
